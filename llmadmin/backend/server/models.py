...
class InitializationConfig(BaseModelExtended):
    initializer: Annotated[
        Union[DeepSpeed, DeviceMap, SingleDevice, LlamaCpp, Finetune, AutoModel], Field(discriminator="type")
    ]
    pipeline: Union[Literal["default"], Literal["llamacpp"], Literal["defaulttransformers"]] = None
