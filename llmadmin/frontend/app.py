...
@serve.deployment()
class LLMAdminFrontend(GradioIngress):
    def __init__(self,url):
        # LLMAdmin deployment simply silences the unnecessary gradio info calls.
        ...
        self.BACKEND = get_llmadmin_backend(url)
    ...
    def gradio_app_builder(self):
        ...
        with gr.Blocks(
            ...
            with gr.Row(elem_classes="header"):
                ...
                # )
                # gr.HTML(
                #     "<a href='https://bit.ly/run-llmadmin' target='_blank' id='deploy-button'>Deploy your LLMs</a>",
            ...
            with gr.Tab("Models", elem_id="models-tab"), gr.Row(
                elem_id="llmadmin-model-desc"
            ), gr.Row():
                gr.Markdown(self.MODEL_DESCRIPTIONS)

            # with gr.Tab("About"), gr.Row(elem_id="llmadmin-desc"):
            ...
            with gr.Row(elem_id="footer"):
                gr.HTML(
                    f"<a href='https://github.com/vincent-pli/llmadmin-general/'>{LOGO_GITHUB}<span>GitHub</span></a>"
                )
            return demo
